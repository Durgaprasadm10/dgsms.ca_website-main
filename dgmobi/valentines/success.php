    ...
    if ($transationDetails) {
        ...
        if ($productDetails) {
            ...
            foreach ($productDetails as $product) {
                ...
                if ($product["dgmobi_buynow_product_app_name"] == "generic") {
                    $safetyemail = "yes";
                }
//                
...
if($transationDetails["dgmobi_buynow_pricetype"] != "renew")
            ...
            if ($safetyemail == "yes") {
                $arr1['safetyemail'] = "sridevi.akurathi@ideabytes.com";
            } else {
                $arr1['safetyemail'] = "";
            }
...
if ($selectedLanguage == "english") {
  ...
  $successImageLink = "images/order-thanks-english-valentaine-2020.jpg";
} else if ($selectedLanguage == "french") {
    //$successImageLink = "images/order-thanks-fr.jpg";
  //  $successImageLink = "images/order-fr-thanku.jpeg";
  $successImageLink = "images/order-thanks-french-valentaine-2020.jpg";
} else if ($selectedLanguage == "spanish") {
   // $successImageLink = "images/order-sp-thanku.jpeg";
    //$successImageLink = "images/order-thanks-sp.jpg";
  $successImageLink = "images/order-thanks-spanish-valentaine-2020.jpg";
} else {
   // $successImageLink = "images/order-en-thanku.jpeg";

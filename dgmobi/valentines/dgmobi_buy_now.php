        ...
        <div class="page" id="top">
            ...
            <section class="page-section">
                <div class="container relative" style="background-color: #d8e7ee">
                    <img src="images/Valentine-dgmobi-web-banner.jpg" alt="DGMobi-logo- Android Based Placard Calculator – that can function stand alone or networked to DGSMS. Compliant to TDG and 49 CFR" width="1170" height="335">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="container relative" align="center">
                        <div class="text" style="font-size: 20px; color: #000;">
                            ...
                            <?php /*<span id="infoFirstLine">
                             ...
                             <span id=infoFirstLine>DGMobi exclusive offer to all HAZMAT/DG Drivers!
Lucky winner of Valentine’s Day Jackpot $250<br>
Draw: Feb 14th 2020</span>
                            
                            <span id="" style="display:none;">
                                Each license purchased before Dec 25, 2018, 
                                adds $1 to Santa's Pot.
                            </span>
                            <span id="infoSecondLine" style="display:none;">$250 to the Valentine Jackpot Winner. Draw on Feb 14th 2020.</span>
                            <br>
                            <span style="color: darkred">
                                <span id="santasPotAmountText">Offer Buyer count</span>: 
                        ...
                        <div class="row" style="">
                            <div class="col-sm-12">
                                <span style="color: darkred; font-weight: bold;text-align: left;" id="">
                                    <span id="conditionText">Subscribe to our Youtube channel to win $50. Winner drawn every month <a href=https://www.youtube.com/watch?v=WIB3Uc-zsm4 target=_blank>https://www.youtube.com/watch?v=WIB3Uc-zsm4</a></span>
                                </span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 text" style="font-size: 20px; color: #000;">
                                ...
                                <ul style="text-align:left;">
                                    <li style="font-weight: bold; color: #0022a7;" id="criticalDataText">Unlike free apps, DGMobi never shares your data with third parties which could pose a security risk.</li>
                                    ...
                                    <li id="supportContactText">Users can access 24x7 support at 1-888-409-8057 EXT 1004 or by E-mail <a href=support@dgmobi.com>support@dgmobi.com</a></li>
                    ...
                    <section class="page-section" style="padding-bottom: 0px;">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <form action="#" name="landstar_form" id="landstar_form" target="_myFrame" class="dg-form">
                                <header id="selectLicensesText">Select the DGMobi<sup>TM</sup> License to Purchase</header>
                                <fieldset>
                                    <center>
                                        <div class="text-center">
                                            <input type=radio name=type value=new onchange=fn1(this.value) checked><span style="font-size: 15px;" id="newlicense">New License</span> &nbsp;&nbsp; <input type=radio onchange=fn1(this.value) name=type value=renew><span id=RenewLicense style="font-size: 15px;">Renew License</span>&nbsp;&nbsp; <input type=radio onchange=fn1(this.value) name=type value=life><span id=lifetime style="font-size: 15px;">Lifetime License</span>
                                        </div>
...
//                                                }
                                ...
                                <footer>
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-6">
                                            ...
                                            <label class="select">
                                                <select id="device_select_id" onchange="getProductsForDisplay(this.value)" required>
                                    ...
                                    <div class="row">
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                ...
                                                <input type="text" name="phone_no" id="phone_no" maxlength="11"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                            </label>
                                        </section>
                                        <section class="col col-6">
                                    ...
                                    <div class="row">
                                        <section class="col col-6">
                                            <label class="checkbox">
                                                ...
                                                <a href="http://dgsms.ca/licensing-terms.php" target="_blank"><span id="termsAndConds">I accept Terms and Conditions</span></a>
                                            </label>
                                        </section>
                                    </div>
                                </footer>
                    ...
                    <section>
                        <p class="text" style="font-size: 15px; color: #000; text-align: center;">
                            ...
                            <br>
                            <span id="disclaimerLineTwo" style="display:none;">
        ...
        <script>
                                                ...
                                                var type = "new";
                                                var cfrUsaOptionText = "<?php echo Config::cfrUsaOptionText; ?>";
                                                var tdgCaOptionText = "<?php echo Config::tdgCaOptionText; ?>";

                                                var cfrUsaOptionValue = "<?php echo Config::cfrUsaOptionValue; ?>";
                                                var tdgCaOptionValue = "<?php echo Config::tdgCaOptionValue; ?>";

                                                var andriodDeviceOptionText = "<?php echo Config::andriodDeviceOptionText; ?>";
                                                var iosDeviceOptionText = "<?php echo Config::iosDeviceOptionText; ?>";

                                                var andriodDeviceOptionValue = "<?php echo Config::andriodDeviceOptionValue; ?>";
                                                var iosDeviceOptionValue = "<?php echo Config::iosDeviceOptionValue; ?>";
                                                var validatename = "yes";
                                                var getProductsForDispalyApi = "<?php echo Config::getProductsForDispalyApi; ?>";
                                                // Global Variables
                                                var productsList = [];
                                                ...
                                                function fn1(val) {
                                                    ...
                                                    if (val == "renew") {
                                                        ...
                                                        $("#country, #province").removeAttr("disabled");
                                                        price = "20";
                                                    } else if (val == "life") {
                                                        validatename = "yes";
                                                        $("#usernameval").css("display", "none");
...
//                                                        commonPopUpMessage(translation.emailError[language], "DGMOBI ERR_07");
                                                        commonPopUpMessage(translation.emailValidationError[language], "DGMOBI ERR_07");
                                                        return false;
                                                    }
                                                }
...
//                                                                            getProductsList();
                                                ...
                                                function setRegulationOptions() {
                                                    ...
                                                    document.getElementById('rule_select_id').innerHTML = "<option value='' disabled>select</option><option value='" + cfrUsaOptionValue + "'>" + cfrUsaOptionText + "</option><option value='" + tdgCaOptionValue + "'>" + tdgCaOptionText + "</option>";
                                                    setDeviceOptions(document.getElementById("rule_select_id").value)
                                                }
...
//                                                                            $("#divEmailCheck").html("");
                                                ...
                                                function getProductsForDisplay(type) {
                                                    $('#product_select_id').empty();
                                                    var deviceid = $("#device_select_id").val();
                                                    if (deviceid == "ios") {
                                                        deviceid = "1";
                                                    } else {
                                                        deviceid = "0";
                                                    ...
                                                    var jsonData = productsList11;
                                                    for (var i = 0; i < jsonData.length; i++) {
//                                                        if (jsonData[i].dgmobi_buynow_product_app_name != "landstar" && jsonData[i].dgmobi_buynow_product_app_name != "dayandross") {
                                                        if (jsonData[i].dgmobi_buynow_product_app_name != "dayandross") {
                                                            if (regulation == jsonData[i].dgmobi_buynow_product_regulation && deviceid == jsonData[i].dgmobi_buynow_product_device_id) {
                                                                optionHTML += '<option value="' + jsonData[i].dgmobi_buynow_product_id + '" data-type="' + regulation + '" data-value="' + jsonData[i].dgmobi_buynow_product_app_name + '">' + jsonData[i].dgmobi_buynow_product_name + '</option>';
                                                            }
                                                        }
                                                    }
...
//                                                                                    var optionHTML = "<option value='' disabled>Select Product</option>";
//                                                                                    if (Object.keys(response.results.countryDetails).length) {
//                                                                                        $.each(response.results.countryDetails, function (key1, value1) {
//                                                                                            if (value1['mobileAppName'] != "landstar" && value1['mobileAppName'] != "dayandross") {
//                                                                                                //optionHTML += '<option  value="'+value1['mobileAppName']+'">'+value1['displayName']+'</option>';
//                                                                                                optionHTML += '<option value="' + value1['mobileAppName'] + '">' + value1[type] + '</option>';
//                                                                                            }
//                                                                                        });
//                                                                                    }
//                                                                                    $('#product_select_id').append(optionHTML);
...
//                                                                            return false;
                                                ...
                                                $('#product_select_id').change(function () {

                                                    productsList = [];

                                                    for (var i = 0; i < productsList11.length; i++) {
                                                        if (productsList11[i].dgmobi_buynow_product_id == $(this).val()) {
                                                            var dataObj = {
...
//                                                                            productsList[productsList.length] = dataObj;
                                                    ...
                                                    formDetails.totalPrice = price;

                                                    var type = $("#product_select_id").find(':selected').data('type');
                                                    if (type == "TDG") {
                                                        formDetails.totalNoOfLicensesTDG = 1;
                                                    } else {
                                                        formDetails.totalNoOfLicenses49CFR = 1;
                                                    }
                                                    formDetails.totalNoOfLicenses = 1;
...
//                                                                        }
                                                ...
                                                function fncheckdetails(value) {
                                                    if ($('#product_select_id').val().trim() == "") {
                                                        commonPopUpMessage(translation.productCountError[language], "DGMOBI ERR_04");
                                                        return false;
                                                    }
                                                    var app = $("#product_select_id").find(':selected').data('value');
                                                    var deviceid = $('#device_select_id').val().trim();
                                                    if (deviceid == "ios") {
                                                        deviceid = "1";
                                                    } else {
                                                        deviceid = "0";
...
//                                                                            alert(app)
                                                    if (type == "renew" && value.trim() != "") {
                                                        $.ajax({
                                                            url: 'checkuserdetails.php',
                                                            method: "POST",
                                                            async: false,
                                                            cache: false,
                                                            data: {'username': value, 'appname': app},
                                                            //dataType: 'json',
                                                            //contentType: "application/json",
...
//                                                                                                console.log(product[i].dgmobi_buynow_product_device_id)
//                                                                                                console.log(deviceid)
                                                                        if (deviceid == product[i].dgmobi_buynow_product_device_id) {
                                                                            optionHTML += '<option value="' + product[i].dgmobi_buynow_product_id + '" data-type="' + product[i].dgmobi_buynow_product_regulation + '" data-value="' + product[i].dgmobi_buynow_product_app_name + '">' + product[i].dgmobi_buynow_product_name + '</option>';
                                                                        } else {
...
//                                                                                                dt += '<tr><td class="purchase-header"><span class="tax-header">' + product[i].dgmobi_buynow_product_name + '</span></td><td>US $ <span class="price">' + pricenow + '</span></td><td><div class="count-input space-bottom"><span class="inc_dec" onclick="return incrementOrDecrement(0,' + product[i].dgmobi_buynow_product_id + ');"><a class="incr-btn1" data-action="decrease" href="#">–</a></span><input class="quantity" style="float:left; width:40%;margin-top:6px;" type="text" id="no_of_licenses_' + product[i].dgmobi_buynow_product_id + '" name="quantity" disabled="" value="0"><span class="inc_dec" onclick="return incrementOrDecrement(1,' + product[i].dgmobi_buynow_product_id + ');"><a class="incr-btn1" data-action="increase" href="#">+</a></span></div></td><td>$ <span id="price_of_' + product[i].dgmobi_buynow_product_id + '">0</span></td></tr>';
                                                                    ...
                                                                    $("#product_select_id").html(optionHTML);
...
//                                                                                            $(".producttable").css("display", "block");
                                                                    ...
                                                                    $("#country, #province").attr("disabled", "disabled");
                                                ...
                                                function clearFormElements() {
                                                    $("#f_name, #l_name, #email_id, #phone_no, #address, #country, #province, #us_name, #device_select_id").val("");
                                                    $("#product_select_id").html("")
                                                    $("#province_section").hide();
                                                    productsList.map(function (dataObj, index) {
						    ...
						    $("#terms").prop("checked", false);
                                                ...
                                                function submitFormElements() {
                                                    ...
                                                    if($("#device_select_id").val() == ""){
                                                        //commonPopUpMessage("Select device", "DGMOBI ERR_04");select_device_label
							commonPopUpMessage(translation.select_device_label[language], "DGMOBI ERR_04");
                                                        return false;
                                                    }
                                                    
                                                    if (formDetails.totalNoOfLicenses <= 0 || $("#product_select_id").val().trim() == "") {
                                                        //commonPopUpMessage("At least one product should be added for purchase.","DGMOBI ERR_04");
                                                        commonPopUpMessage(translation.productCountError[language], "DGMOBI ERR_04");
                                                        return false;
                                                    }

                                                    if (formDetails.usname == "" && validatename == "no") {
                                                        //commonPopUpMessage("Enter username", "DGMOBI ERR_04");noUserName
                                                        commonPopUpMessage(translation.noUserName[language], "DGMOBI ERR_04");
                                                        return false;
                                                    }
                                                    if (formDetails.firstname == "" && validatename == "yes") {
                                                    ...
                                                    if (formDetails.firstname.length < 4 && validatename == "yes") {
                                                        //commonPopUpMessage("First Name must contains atleast 4 characters.","DGMOBI ERR_01");
                                                        commonPopUpMessage(translation.firstNameCountError[language], "DGMOBI ERR_01");
                                                        return false;
                                                    }
                                                    if (formDetails.lastname == "" && validatename == "yes") {
                                                    ...
                                                    if (formDetails.lastname.length < 4 && validatename == "yes") {
                                                    ...
                                                    if (formDetails.email == "") {
                                                        ...
                                                        return validateEmail();return false;
                                                    }
                                                    ...
                                                    if (formDetails.countryName == "CANADA") {
                                                        if (formDetails.provinceName == "" || $("#province").val()=="") {

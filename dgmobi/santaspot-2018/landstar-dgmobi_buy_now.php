        ...
        <div class="page" id="top">
            ...
            <section class="page-section">
                <div class="container relative" style="background-color: #d8e7ee">
                    <img src="images/landstar-dgmobi-2018.jpg" alt="DGMobi-logo- Android Based Placard Calculator – that can function stand alone or networked to DGSMS. Compliant to TDG and 49 CFR" width="1170" height="335">
                    <?php //<img src="images/landstar-dgmobi-winner.jpg" alt="DGMobi-logo- Android Based Placard Calculator – that can function stand alone or networked to DGSMS. Compliant to TDG and 49 CFR" width="1170" height="335"> ?>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="container relative" align="center">
                        <div class="text" style="font-size: 20px; color: #000;">
                            ...
                            <span id="infoFirstLine">
                                <!--                                DGMobi is offering exclusively to Landstar BCOs a chance to win a 
                                                                percentage of Santa's Pot.-->
                                DGMobi is offering 1000 FREE One year subscription exclusively to Landstar BCOs a chance to win a prize in Santa's Pot.
                            </span>
                            <br>
                            <span id="infoSecondLine">
                                <!--                                Each license purchased before Dec 25, 2017, 
                                                                adds $1 to Santa's Pot.-->
                                Every download adds $1to the Santa's pot
                            </span>
                            <br>
                            <span style="color: darkred">
                                <span id="santasPotAmountText">Santa's Pot Amount</span>: 
                                <strong>&dollar;<?php echo $santasBagCount; ?></strong>
                            </span>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <span style="color: darkred; font-weight: bold;text-align: left;" id="">
                                    <small> <span id="conditionText">*Conditions Apply (Draw is valid after 1000 New registrations on or before 25th of December 2018)</span></small>
                                </span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 text" style="font-size: 20px; color: #000;">
                                ...
                                <ul style="text-align:left;">
                                    <li style="font-weight: bold; color: #0022a7;" id="criticalDataText">Critical data - load content and location are protected. Never shared with 3rd party for advertising.</li>
                    ...
                    <section class="page-section" style="padding-bottom: 0px;">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <form action="#" name="landstar_form" id="landstar_form" target="_myFrame" class="dg-form">
                                <header id="selectLicensesText">Select the DGMobi Annual License(s) to Subscribe</header>
                                <fieldset>
                                    <center>
                                        <table class="table table-striped shopping-cart-table responsive" style="width: 80%; background-color: #fff; border:3px double #328444;">
                                            <tr align="center">
                                            ...
                                            <?php
                                            foreach ($productsList as $key => $data) {
...
//                                                . '<span class="inc_dec" onclick="return incrementOrDecrement(1,' . $data["dgmobi_buynow_product_id"] . ');"><a class="incr-btn1" data-action="increase" href="#">&plus;</a></span></td>';
                                                echo '<td>'
                                                . '<input type=checkbox class=quantity id="no_of_licenses_' . $data["dgmobi_buynow_product_id"] . '" name="quantity" cdata="' . ($key + 1) . '" >'
                                                . '</td>';
                                                        ...
                                                        <footer>
                                                            <div class="row">
                                                                <section class="col col-7">
                                                                    <p style="float:left;"><span id="volumePurchaseContact">For volume subscribe, please contact</span>: <a href="mailto:sales@dgmobi.com">sales@dgmobi.com</a></p>
                                                                </section>
                                                                ...
                                                                <section class="col col-3">
                                                                    <button type="submit" class="button" id="submitForm" onclick="return false;" style="margin-top: 5px; float: left; min-width: 140px; padding: 0px;">Submit</button>
                                                                </section>
                                                            </div>
                                                        </footer>
                                                        </form>
...
//                                                                increaseOrDecreaseProductValue(clickedId, newVal);
                                                                $(".quantity").change(function () {
                                                                    ...
                                                                    var pos = (pieces.length)-1;
                                                                    var clickedId = pieces[pos];
                                                                    if ($(this).prop("checked")) {
                                                                        cnt++;
                                                                        increaseOrDecreaseProductValue(clickedId, 1);
//                                                                        alert($(this).attr("cdata"))
                                                                    } else {
                                                                        cnt--;
                                                                        increaseOrDecreaseProductValue(clickedId, 0);
//                                                                        alert("unchecked")
                                                                    }
                                                                    $("#total_no_of_licenses").html(cnt)
                                                                });
                                                            });
                                                        </script>
                                                                            ...
                                                                            $.ajax({
                                                                                ...
                                                                                success: function (data) {
                                                                                    ...
                                                                                    if (data == "success") {
                                                                                        ...
                                                                                        commonPopUpMessage("Already Registered", translation.sthWentWrong[language]);
                                                                                    } else {

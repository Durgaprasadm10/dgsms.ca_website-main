    ...
    if ($transationDetails) {
        ...
        if ($productDetails) {
            ...
            foreach ($productDetails as $product) {
                ...
                $productInfo["price"]           = (string) $product["dgmobi_buynow_product_price"];
            ...
            if ($totalNoOfLicensesTDG > 0) {
                ...
                $resultCA = $curlHandler->sendJSONInPOST($CAServiceCallURL, $response);
            ...
            if ($totalNoOfLicenses49CFR > 0) {
                ...
                $resultUS = $curlHandler2->sendJSONInPOST($USServiceCallURL, $response);

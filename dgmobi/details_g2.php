...
if($envVar == "dev"){
	...
	$mobileRegistrationUserUpdateApi_US = "http://dgapptest.dgsmsusa.com/api/mobile/registrationUpdationLog/1.json";
	$mobileRegistrationUserUpdateApi_CA = "http://dgapptest.dgsms.ca/api/mobile/registrationUpdationLog/1.json";

	$sendMailToUserApi_US = "http://dgapptest.dgsmsusa.com/api/mobile/sendmailToRegisterUser.json";
	...
	$mobileRegistrationUserUpdateApi_US = "http://dgapp.dgsmsusa.com/api/mobile/registrationUpdationLog/1.json";
	$mobileRegistrationUserUpdateApi_CA = "http://dgapp.dgsms.ca/api/mobile/registrationUpdationLog/1.json";

	$sendMailToUserApi_US = "http://dgapp.dgsmsusa.com/api/mobile/sendmailToRegisterUser.json";

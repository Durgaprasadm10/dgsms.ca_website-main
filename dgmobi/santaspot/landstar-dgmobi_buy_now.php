        ...
        <div class="page" id="top">
            ...
            <section class="page-section">
                <div class="container relative" style="background-color: #d8e7ee">
                    <img src="images/landstar-dgmobi-web-2019-winner.jpg" alt="DGMobi-logo- Android Based Placard Calculator – that can function stand alone or networked to DGSMS. Compliant to TDG and 49 CFR" width="1170" height="335">
                    <div class="row">
                        <div class="col-md-12">

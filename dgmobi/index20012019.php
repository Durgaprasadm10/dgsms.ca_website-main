            ...
            <section class="page-section">
                <div class="container relative">
                   ...
                   <!-- <a href="santaspot" ><img style="float:right;" src="images/landstar-bco-santa-bag_italic_size_red.png" width="199" height="51" alt="Landstar Bco Santa's Bag"/></a> -->
                    <!-- <a href="valentines" style="width: 190px;height: 50px;margin-top: 3px;float: right;
    border: 1px solid black;background: #de1112;color: #fffefe;text-decoration: none;"><span style="">Valentines Offer</span></a> -->
                    <a href="valentines" ><img style="float:right;height:51px;" src="images/valentain-offer.png" width="199"  alt="Valentines Offer"/></a> 

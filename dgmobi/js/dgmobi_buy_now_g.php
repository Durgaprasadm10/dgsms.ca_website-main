...
<!-- END OF Price Display MODAL -->
			...
			var getPriceApi = "/api/mobile/new/checkdevicepaymentstatus.json";
			var getProductsForDispalyApi = "/api/mobile/new/displayappnameandcostinformation.json";
			...
			/*
			$productNameArray = array("1" => "DGMobi US General", "2" => "DGMobi US Landstar BCO Discount", 
										"3"=>"DGMobi US General", "4"=>"DGMobi US Landstar BCO Discount", 
										"5"=>"DGMobi CA General", "6"=>"DGMobi CA Landstar BCO Discount", 
										"7"=>"DGMobi CA Midland", "8"=>"DGMobi CA Day&Ross");
			*/
			var passwordValCheck = "no"; var emailValCheck = "no"; var phnoValCheck = "no"; 
			var mobileRegistrationCheck = "no";var storeDataInDb = "no";			
			var gotProductPrice = "no";
								...
								if(Object.keys(response.results.paymentDetails).length) {
									alert("length if -- ");
									 $.each(response.results.paymentDetails, function (key1, value1) {
										...
										var actualproductId = value1["productId"];
										var actualPriceOfProduct = value1["price"];
									    priceOfProductWithTax = actualPriceOfProduct;
										var currencyOfProductPrice = value1["currency"];
										amountDisplayAlertText += "<tr><td>App Price</td><td>"+actualPriceOfProduct+"</td></tr>";
										...
										$.each(value1["taxInfo"], function (key2, value2) {
											...
											$.each(value2, function (key3, value3) {
												...
												alert("taxAmt = " + taxAmt);
												amountDisplayAlertText += "<tr><td>"+key3+" ("+value3+"%)</td><td>"+taxAmt+"</td></tr>";
											});		
										});	
										
									});
									amountDisplayAlertText += "<tr><td>Grand Total</td><td>"+priceOfProductWithTax+"</td></tr></table>";

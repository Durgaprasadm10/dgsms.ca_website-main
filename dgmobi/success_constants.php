...
if($paramsArray['mode'] == "CFR"){
	...
	$supportEmail = $supportEmailForUsa;
}else{
	$url = $mobileRegistrationUserUpdateApi_CA;
	$supportEmail = $supportEmailForCa;
}

if($txn_id == ""){
	echo sprintf($paymentErrorText, $order_id, $supportEmail, $supportEmail);
}else{
	...
	//	echo $url1 . "<br>";
		...
		*/
		...
		if($emailResponeStatus == "00"){
			...
			//echo "<br>";
			//echo $displayText2;
			echo sprintf($successText, $productName, $mobileType, $mobileTypeText, $productName, $couponCodeText, $noteText, $supportEmail, $supportEmail);

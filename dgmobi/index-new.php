                    ...
                    <div class="section-text mb-30 mb-sm-20">
                        <div class="row">
                            ...
                            <div class="col-md-7  mb-xs-30">
                             ...
                             <h1 class="section-title font-alt align-left mb-sm-10">
                        DGMobi<sup>™</sup> - Your companion to DOT 49 CFR, TDG Compliance </h1>

<p><img style="margin-bottom:10px; margin-left: 10px; margin-top:10px; float:right;" src="ios/Insert-Main-Screen.png" width="200" height="300" alt="dgmobi--ios-Mainscreen" />Getting certified in DOT 49 CFR or TDG is a challenge in itself. Can one expect you to remember all the rules that control the display of placarding on the truck?</br>
...
DOT 49 CFR segregation rules are complex, whereas TDG segregation only encompasses Class 1 ( explosives). </p>

<h1 class="section-title font-alt align-left mt-30 mb-sm-10">
                        HRCQ and ERAP: <img style="margin-bottom:10px; margin-left: 10px; margin-top:10px; float:right;" src="ios/HRCQ.png" width="200" height="300" alt="dgmobi-ios-hrcq" /> </h1>
...
<h1 class="section-title font-alt align-left  mt-30 mb-sm-10">
                        ERG: <img style="margin-bottom:10px; margin-right: 10px; margin-top:10px; float:left;" src="ios/ERG-Main.png" width="200" height="300" alt="dgmobi--ios-PlacardScreen" /> </h1>
...
<h1 class="section-title font-alt align-left mb-sm-10">
                       Record keeping:   </h1>
 <p>All the transactions on DGMobi™ are maintained in the cloud for 3 years as long as the DGMobi™ is valid. In an audit, the driver is confident to display a list of loads that were hauled in full compliance of DOT 49 CFR or TDG.

If your company uses DGSMS<sup>&reg;</sup>, Dispatchers from terminal can push transactions for pick to the DGMObi™ terminal eliminating the need to reenter the information manually. </p>                       
  
<h1 class="section-title font-alt align-left mb-sm-10">
                     Placarding modes: Safety and Permissive :   </h1>    
                     
 <p>An LTL truck driver always seeks to optimize the placards displayed and comply with regulations. To achieve this DGMobi™ provides the permissive placarding mode with 3 levels of placarding optimization: 1) Optimized, 2) semi-optimized and 3) non-optimized. All 3 modes are fully compliant with the regulations and will pass scrutiny of an inspecting. </p>
...
<h1 class="section-title font-alt align-left mb-sm-10">
 ...
 <p>DGMobi™ is available to companies with customized logos and a central point of data collection which can be synchronized with a local copy of DGSMS<sup>&reg;</sup>. Pricing is given based on volume of annual licenses. Please contact <a href="mailto:sales@dgsmsusa.com" target="_blank">sales@dgsmsusa.com</a> for more information. </p>      

</div>
<div class="col-md-5  mb-xs-30">
  <div class= "video">        
<iframe src="https://www.youtube.com/embed/uBPaZ7chDGY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> </div>
  ...
  ?>
					...
					<section>
						...
						<span style="font-size: 15px;" id="newlicense">New License</span> &nbsp;&nbsp; 
						<input type="radio" onchange="fn1(this.value)" name="type" value="old">
						<span id="RenewLicense" style="font-size: 15px;">Renew License</span>&nbsp;&nbsp; 
						<input type="radio" onchange="fn1(this.value)" name="type" value="life">
						<span id="lifetime" style="font-size: 15px;">Lifetime License</span>
					</section>
                    ...
                    <div class="row" id="pass_sec">
						<section class="col col-6">
							<label class="label" id="password_label">Password</label>
							<label class="input">
								<i class="icon-append icon-lock"></i>
								<input type="password" name="password" id="password" maxlength="4" title="password musts be 4 charecters length" onchange="passwordOnChange();" >
                        ...
                        <section class="col col-6">
							...
							<label class="input">
								<i class="icon-append icon-lock"></i>
								<input type="password" name="confirm_password" id="confirm_password" maxlength="4" onchange="confirmpasswordOnChange();" >
...
<!-- END OF Price Display MODAL -->
			...
			function fn1(val) {
				if(val=="old") {
					...
					$("#generated_username").removeAttr("readonly");
					//$("#name_on_card").removeAttr("readonly");
					passwordValCheck = "yes";
				}else {
					$("#pass_sec").css("display","block");
					$("#password").attr("required", "required");
					$("#confirm_password").attr("required", "required");
					$("#generated_username").attr("readonly", "readonly");
					//$("#name_on_card").attr("readonly", "readonly");
					passwordValCheck = "no";
				}
				type=val;
				getProductsForDisplay(type);
			}
...
alert("type "+type);
				  if(type=="old") {
				 	 var product_select_id = $('#product_select_id').val();
					  if(product_select_id==""){
						alert("Please select product");
						$("#name_on_card").val("");
						$('#product_select_id').focus();
						return false;
					  }
				  }
			 ...
			 */
				...
				//e.preventDefault();
					...
					if(product_select_id==""){
						...
						var markersun = { username : generatedusername, appname: product_select_id };

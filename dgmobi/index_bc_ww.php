...
//	include_once('dbconfig.php');
	...
	var_dump($paypalURL);
	echo "$$$$$$$$$$$$**************";*/
	//include_once ('http://dgsms.ca/details.php'); //always details has to load for all variables avail.
	//Include DB configuration file
	//include_once ('http://dgsms.ca/dbconfig.php');
			  ...
			  function generateUsername(){
			   ...
			   //function VerifyUsername(sender, e) {
				...
				//e.preventDefault();
					...
					//testserver
					//var us_verification_url = "http://104.238.67.134:80/DGSMS_US_WS_SERVER_WEB_ANDROID/api/mobile/verifyUserExistOrNotForCart.json";
					//liveserver
					var us_verification_url = "http://104.238.79.21:80/DGSMS_US_WS_SERVER_BETA/api/mobile/verifyUserExistOrNotForCart.json";
					//testserver	
					//var ca_verification_url =  "http://104.238.67.134/DGSMS_CA_WS_SERVER/api/mobile/verifyUserExistOrNotForCart.json";
					//liveserver
					var ca_verification_url =  "http://104.238.87.154:80/DGSMS_CA_WS_SERVER/api/mobile/verifyUserExistOrNotForCart.json";
						
						//alert("VerifyUsername starting --");
				        var selected_rule_value = document.getElementById('rule_select_id').value; 
						if(selected_rule_value == ""){
							alert("Please select Regulation");
							return false;
						}else{
							//alert("coming here in else --" + selected_rule_value);
							if(selected_rule_value == "1"){
								presernt_verifi_url = us_verification_url;
								//$("#verification_url").val(us_verification_url);
								//alert("coming here in else -- and 1 "+ selected_rule_value);
							} else{
								presernt_verifi_url = ca_verification_url;
								//$("#verification_url").val(ca_verification_url);
								//alert("coming here in else -- and 2 "+ selected_rule_value);
							}
						}
						...
						$.ajax({					
							...
							//url: "http://104.238.67.134/DGSMS_US_WS_SERVER_BETA/api/mobile/verifyUserExistOrNotForCart.json",
							//url: "http://192.168.1.49/DGSMS_CA_WS_SERVER/api/mobile/verifyUserExistOrNotForCart.json",
							//url: "http://DGSMS_US_WS_SERVER/api/mobile/verifyUserExistOrNotForCart.json",
							//the below is ca test server
							//url: "http://104.238.67.134/DGSMS_CA_WS_SERVER/api/mobile/verifyUserExistOrNotForCart.json",
							//the below is us test server
							//url: "http://104.238.67.134/DGSMS_US_WS_SERVER_WEB_ANDROID/api/mobile/verifyUserExistOrNotForCart.json",
							//url:"http://104.238.67.134:80/DGSMS_US_WS_SERVER_WEB_ANDROID/api/mobile/verifyUserExistOrNotForCart.json",
							//url: "http://104.238.67.134/DGSMS_CA_WS_SERVER/api/mobile/verifyUserExistOrNotForCart.json",
				...
				//e.preventDefault();
					...
					//testserver
					//var us_mobile_registration_url = "http://104.238.67.134/DGSMS_US_WS_SERVER_WEB_ANDROID/api/mobile/registrationUpdationLog/0.json";
					//liveserver
					var us_mobile_registration_url = "http://104.238.79.21:80/DGSMS_US_WS_SERVER_BETA/api/mobile/registrationUpdationLog/0.json";
					//testserver
					//var ca_mobile_registration_url =  "http://104.238.67.134/DGSMS_CA_WS_SERVER/api/mobile/registrationUpdationLog/0.json";
					//liveserver
					var ca_mobile_registration_url =  "http://104.238.87.154:80/DGSMS_CA_WS_SERVER/api/mobile/registrationUpdationLog/0.json";	
						//alert("mobile registration starting --");
				        var selected_rule_value = document.getElementById('rule_select_id').value; 
						if(selected_rule_value == ""){
							alert("Please select Regulation");
							return false;
							...
							//alert("coming here in else --" + selected_rule_value);
							if(selected_rule_value == "1"){
								presernt_mobile_registration_url = us_mobile_registration_url;
								//$("#verification_url").val(us_verification_url);
								//alert("coming here in else -- and 1 "+ selected_rule_value);
							} else{
								presernt_mobile_registration_url = ca_mobile_registration_url;
								//$("#verification_url").val(ca_verification_url);
								//alert("coming here in else -- and 2 "+ selected_rule_value);
							}
						}
						...
						//return false;
						$.ajax({
							//http://104.238.67.134/DGSMS_US_WS_SERVER_WEB_ANDROID/api/mobile/registrationUpdationLog/{status}.json
							//here status is 0 for registration and 1 for updation after paypal payment is success full
				...
				function activityLog(actionStatus) {
				//e.preventDefault();
					var presernt_activity_log_url = "";
					var us_activity_log_url = "http://104.238.67.134/DGSMS_US_WS_SERVER_WEB_ANDROID/api/mobile/insertdgmobiactivitylog.json";
					var ca_activity_log_url =  "http://104.238.67.134/DGSMS_CA_WS_SERVER/api/mobile/insertdgmobiactivitylog.json";
						
						//alert("activity log starting --");
				        var selected_rule_value = document.getElementById('rule_select_id').value; 
						if(selected_rule_value == ""){
							alert("Please select Regulation");
							return false;
							...
							//alert("coming here in else --" + selected_rule_value);
							if(selected_rule_value == "1"){
								presernt_activity_log_url = us_activity_log_url;
								//$("#verification_url").val(us_verification_url);
								//alert("coming here in else -- and 1 "+ selected_rule_value);
							} else{
								presernt_activity_log_url = ca_activity_log_url;
								//$("#verification_url").val(ca_verification_url);
								//alert("coming here in else -- and 2 "+ selected_rule_value);
							}
						}
						//alert("presernt_activity_log_url = " + presernt_activity_log_url);
						...
						var companyNameVal = product_company[selected_product_value];
								//alert("comp name" + companyNameVal);	
						var action = "web : user registration activity, status = " + actionStatus;	
						
						var markersun = {Data:[{app_name:companyNameVal,app_version:"",os_version:"",action:action,mobile_model:"",user_name:generatedusername,device_Id:""}]}
						//alert(JSON.stringify(markersun));
						//console.log(JSON.stringify(markersun));
						//return false;
						$.ajax({
							url: presernt_activity_log_url,							
							method: "POST",
							 async:false,
							data: JSON.stringify(markersun),
							dataType: 'json',
							contentType: "application/json",
							success: function(response, results,jqXHR){
								//alert(JSON.stringify(response.results.status));								
				...
				$(document).ready(function(){
					...
					//https://forum.jquery.com/topic/refresh-dynamic-selectmenu
					//$('#rule_select_id').selectmenu('refresh');

...
$subject = "Message from contact page dgsms.ca";
	...
	try{
		$result1 = $mail12->send($sesHost, $sesKey, $sesSecret,$mailport, $senderMail, $subject, $body, $to);
		$result2 = $mail12->send($sesHost, $sesKey, $sesSecret,$mailport, $senderMail, $subjectToUser, $bodyToUser, $email);
	}catch(Exception $e){

    ...
    <fieldset>
        ...
        <div id="formdisp">
            ...
            <div class="row">
                <section class="">
                        <label class="checkbox">
                            ...
                            <a href="/fr/pages/technical_fr.html" target="_blank" id="terms_anchortag">
                            J'accepter les termes et conditions</a></label>
                </section>
            </div>
            ...
            <div class="row">
                <section class="col">
                <label class="label">
                <span id="footer_notes_text">Pour les ventes en volume - veuillez contacter</span>

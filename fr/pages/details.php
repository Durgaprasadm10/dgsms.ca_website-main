...
$cancelLink = "http://".$_SERVER['SERVER_NAME']."/fr/pages/dgmobi_eng.php";
// $cancelURL = 'http://dgmobi.com/cancel.php';
// $returnURL = 'http://dgmobi.com/success.php';
$cancelURL = "http://".$_SERVER['SERVER_NAME']."/fr/pages/cancel.php";
$returnURL = "http://".$_SERVER['SERVER_NAME']."/fr/pages/success.php";

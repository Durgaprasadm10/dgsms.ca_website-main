        ...
        <div id="formdisp">
            <div class="row">
                <section class="col col-6">
                    <label class="label" for="product">Sélectionner un produit</label>
                    <label class="select">
            ...
            <div class="row">
                ...
                <section class="col col-6">
                    <label class="label" for="phone_number_trial">Numéro de téléphone</label>
                    <label class="input">
            ...
            <div class="row">
                <section class="">
                        <label class="checkbox">
                            ...
                            <a href="/fr/pages/technical_fr.html" target="_blank" id="terms_anchortag1">J'accepter les termes et conditions</a></label>
                </section>
            </div>
            ...
            <div class="row">
                <section class="col">
                <label class="label">
                <span id="footer_notes_text1">Pour les ventes en volume - veuillez contacter</span>
            ...
            <div class="form_footer">
                ...
                <button type="submit" class="button" id="try_now_button_text">Demande</button>

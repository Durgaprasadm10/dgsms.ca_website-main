...
<body>
    <header>
        <nav>
            <div class="container">
                <a href="https://www.ideabytes.com"><img src="../icn/IB_logo_white.png"
                ...
                <ul class="menu">
                    ...
                    <li class="menu_item"><a href="../fr/pages/DGSOS_fr.php" class="link_lang"><img
                                src="../icn/england-flag.png" alt="english lnguage" class="eng"></a></li>
                    <!-- <ul class="lang_menu">
                <li>
    ...
    <footer>
        <div class="container">
            <div class="footer_social">
                <a class="social" href="https://www.linkedin.com/company/ideabytes-inc"><img src="../icn/linkedin.png"
                        alt=""></a>
                <a class="social" href="https://www.facebook.com/dgsmsproducts/"><img src="../icn/Logo_facebook.png"
                        alt=""></a>

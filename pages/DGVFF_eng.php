...
<head>
    ...
    <title>Digital IMDG Segregations for Dangerous Goods Sea Shipments | DGSMS</title>
...
<body>
    <header>
        ...
        <ul class="menu">
            ...
            <li class="menu_item"><a href="../fr/pages/DGVFF_fr.php" class="link_lang"><img src="../icn/french-flag.png" alt="english lnguage" class="eng"></a></li>
            <!-- <ul class="lang_menu">
                <li>
    ...
    <section class="consultation">
        <div class="container">
            ...
            <form id="consultation-form" class="form_feed" action="#">
                <input pattern="[A-Za-z\s]+" required name="product" type="hidden" value="DGVFF"> 
